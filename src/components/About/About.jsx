    ...
    <div className='About'>
       ...
       <article className='flex flex-col justify-center content-center px-8 mt-16 md:mt-0 md:pl-10 md:w-7/12' id="sect">
          ...
          <p className='text-lg text-justify text-silver md:pl-4 pt-0'>
             ...
             and do interesting things that matters; that's why I am thrilled to find a great team that I can learn from, 
             and allows me to bring all my ideas and knowledge to contribute.</p>
